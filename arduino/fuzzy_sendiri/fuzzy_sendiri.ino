...
void loop() {
    int lt = analogRead(ldrlt); // top left baca voltase 0-5 volt
  ...
  // Calculate elevasi, azimuth and azimuth
 ...
 if (-1 * tol > error_vert || error_vert > tol) // selisih rata2 atas dgn toleransi // apakah dia masuk zero error
    {
      if (error_vert>275){
  outvert=10; 
  }
