...
<div class="box box-success">
	...
	<form method="POST" action="<?php echo site_url('Chitung/inputerror'); ?> ">
		<div class="box-body">
						...
						<div class="box-body">
							<table class="table table-bordered">
								...
								<tr>
									...
									<td>
										<a href="<?php echo site_url();?>Chitung/hitungfuzzy/<?php echo $data->error; ?>/<?php echo $data->deltaerror; ?>">
											<button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
											</button>	
										</a>
										<a href="<?php echo site_url();?>Chitung/hapusdata/<?php echo $data->id; ?>">
