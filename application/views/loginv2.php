...
<head>
    <meta charset="UTF-8">
    <title>Websolartracker | Login </title>
    ...
    <body style="background-image: url(' <?php echo base_url('assets/adminlte/dist/img/back.jpg')?>'); background-repeat: no-repeat;
    background-attachment: fixed; " class="login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="#" style="color: white;"><b>SOLAR</b> TRACKER</a>
        </div><!-- /.login-logo -->
